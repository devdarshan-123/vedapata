...
function Section({ product }) {
  ...
  return (
    <div>
      ...
      <section className="w-full bg-gradient-to-r from-[#3a2a1f] to-[#2b1f17] py-10 px-6 md:px-12 lg:px-16 font-[Vidaloka] text-white">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10 text-center md:text-left">
            ...
            <div>
              <p className="text-sm text-[#c9bfa8] font-[Bellefair] mb-2">
                Courses & Certifications <span className="mx-1">›</span> Course
              </p>
              ...
              <div className="flex items-center justify-center md:justify-start gap-4 mb-2">
                <span className="text-lg md:text-xl">₹500.00</span>
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto">
            ...
            <button
              ...
              className="bg-white text-black px-8 py-2 rounded-full hover:opacity-90"
            >
              Add to Cart
            </button>
            ...
            <button
              ...
              className="border border-white text-white px-8 py-2 rounded-full hover:bg-white hover:text-black transition"
            >
              Buy Now
            </button>
